...
#ifndef _EXI_DEVICEMEMORYCARDFOLDER_H
#define _EXI_DEVICEMEMORYCARDFOLDER_H

#include "Common/Thread.h"
class GCMemcardDirectory;
	
class CEXIMemoryCardFolder : public IEXIDevice
{
public:
